...
The user selected the "$ARCHETYPE_NAME" archetype. Here is its template for reference:

```
$ARCHETYPE_HINT
```

Use this as a starting point, but adapt it to the specific topic and project. You can:
