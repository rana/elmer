...
4. **DECISIONS.md** — ADRs with full rationale (57 recorded)
...
*Last updated: 2026-02-25, document routing + per-step prerequisites + model routing defaults (ADR-074), 57 ADRs*
