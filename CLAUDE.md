...
4. **DECISIONS.md** — ADRs with full rationale (11 recorded)
...
| `elmer decline ID` | Discard branch, cleanup |
...
| `elmer mcp` | Start MCP server — 18 tools for Claude Code integration |
...
*Last updated: 2026-02-23, added `elmer amend` command (ADR-028), 18 MCP tools*
